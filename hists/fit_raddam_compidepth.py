...
for i,run in enumerate(runs):
    ...
    filename = inputdir+"hists_sub_HcalTupleMaker_run"+run+"_negieta18_50fb.root"
    ...
    print "Run "+str(runs)+ " mean30 "+str(means_3p30)
    print "Run "+str(runs)+ " mean31 "+str(means_3p31)
    print "Run "+str(runs)+ " mean32 "+str(means_3p32)
...
graph_3p31.Draw("AELPZ")
#graph_3p31.Draw("ELPZ same")
#graph_3p32.Draw("ELPZ same")
...
outname="fit_raddam_gsel0_ieta18_odddepth.pdf"
